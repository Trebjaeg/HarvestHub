      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-6" style={{ fontFamily: 'Poppins, sans-serif' }}>
            Your account is not currently suspended. You can only submit an appeal if your account has been suspended.
          </p>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 max-w-lg w-full text-center">
          ...
          <div className="space-y-3 mb-8" style={{ fontFamily: 'Poppins, sans-serif' }}>
            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
              Your appeal has been received and will be reviewed by our team within{' '}
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6" style={{ fontFamily: 'Poppins, sans-serif' }}>
            <p className="text-sm text-green-800">
              <strong>What's next?</strong> Our team will carefully review your appeal and supporting evidence. 
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div style={{ fontFamily: 'Poppins, sans-serif' }}>
              ...
              <Textarea
                id="explanation"
                name="explanation"
                placeholder="Please explain why you believe your account should be restored. Include any relevant details, context, or evidence that supports your case..."
            ...
            {/* Contact Info */}
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4" style={{ fontFamily: 'Poppins, sans-serif' }}>
              <h4 className="font-medium text-blue-900 mb-2">Your Contact Information</h4>
              <p className="text-sm text-blue-800">
                <strong>Email:</strong> {user.email}
              </p>
              <p className="text-xs text-blue-700 mt-2">
                We will send updates about your appeal to this email address.
              </p>
            </div>
