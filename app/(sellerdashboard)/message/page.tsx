        ...
        {selectedConversation ? (
          <>
            <div className="bg-gradient-to-r from-[#103C2E] to-[#1a5f3f] p-3 md:p-4 flex items-center justify-between shadow-md">
              <div className="flex items-center space-x-2 md:space-x-3 flex-1 min-w-0">
                ...
                {isConnected && (
                  <div className="flex items-center space-x-1.5 text-white/90 text-xs flex-shrink-0">
                ...
                <div className="space-y-2 md:space-y-4">
                  ...
                  {selectedConversation && typingUsers.has(selectedConversation.userId) && (
                    <div className="flex justify-start px-1">
                      <div className="bg-white text-gray-500 rounded-2xl px-3 py-2 md:px-4 md:py-3 shadow-sm rounded-bl-none">
          ...
          <div className="flex-1 flex items-center justify-center bg-[#e8f5e9] p-4">
            <div className="text-center max-w-sm">
              ...
              <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-2">Seller Messages</h3>
