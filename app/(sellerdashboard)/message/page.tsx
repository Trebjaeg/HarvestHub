          ...
          <div className="flex items-center justify-between mb-3">
            ...
            {totalUnreadCount > 0 && (
              <div className="relative">
                <span className={`bg-red-500 text-white text-xs font-bold rounded-full w-6 h-6 flex items-center justify-center ${badgeShake ? 'animate-pulse' : ''}`}>
        ...
        {selectedConversation ? (
          <>
            <div className="bg-gradient-to-r from-[#103C2E] to-[#1a5f3f] p-4 flex items-center justify-between shadow-md">
              <div className="flex items-center space-x-3">
                ...
                {isConnected && (
                  <div className="flex items-center space-x-1.5 text-white/90 text-xs">
            ...
            <div className="flex-1 overflow-y-auto p-6 bg-[#e8f5e9]">
              {messages.length === 0 ? (
                ...
                <div className="space-y-4">
                  {messages
                    ...
                    .map((msg) => {
                      ...
                      return (
                        <div 
                          key={msg._id} 
                          className={`flex ${isOwn ? 'justify-end' : 'justify-start'} ${isPending ? 'opacity-70' : 'opacity-100'} transition-opacity`}
                        ...
                        >
                          <div className={`max-w-[70%] rounded-2xl px-4 py-3 shadow-sm ${
                            ...
                            <div className={`flex items-center justify-between gap-2 mt-1.5 ${isOwn ? 'text-white/70' : 'text-gray-500'}`}>
                              <p className="text-xs">
                  ...
                  {/* Typing indicator */}
                  {selectedConversation && typingUsers.has(selectedConversation.userId) && (
                    <div className="flex justify-start">
                      <div className="bg-white text-gray-500 rounded-2xl px-4 py-3 shadow-sm rounded-bl-none">
            ...
            <div className="bg-white p-4 border-t border-gray-200 shadow-lg">
              <form onSubmit={handleSendMessage} className="flex items-center space-x-3">
                <button
                  type="button"
                  className="text-gray-500 hover:text-[#103C2E] transition-colors p-2 hover:bg-gray-100 rounded-lg"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="m18.375 12.739-7.693 7.693a4.5 4.5 0 0 1-6.364-6.364l10.94-10.94A3 3 0 1 1 19.5 7.372L8.552 18.32m.009-.01-.01.01m5.699-9.941-7.81 7.81a1.5 1.5 0 0 0 2.122 2.12" />
                  </svg>
                </button>
                <input
                  type="text"
          ...
          <div className="flex-1 flex items-center justify-center bg-[#e8f5e9]">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Seller Messages</h3>
              <p className="text-gray-600 text-sm">Select a conversation to chat with your customers</p>
            </div>
          </div>
        )}
      </div>
