      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto">
          ...
          <div 
            ...
            style={{
              backgroundImage: 'url(/images/KALI/unnamed1.jpg)',
              backgroundSize: 'cover',
              backgroundPosition: 'center',
              backgroundRepeat: 'no-repeat'
            }}
            ...
            <div className="relative z-10">
              ...
              <div className="grid md:grid-cols-5 gap-4">
                {[
                  ...
                  <div key={index} className="bg-white/15 backdrop-blur-sm rounded-xl p-4 text-center hover:bg-white/25 transition-all duration-300 hover:transform hover:scale-105">
                    <div className="w-12 h-12 bg-white/25 rounded-full mx-auto mb-3 flex items-center justify-center">
                      <status.icon className="w-6 h-6" />
                    </div>
                    <h4 className="font-semibold mb-1 text-sm" style={{ fontFamily: 'Poppins, sans-serif' }}>
                      {status.label}
                    </h4>
                    <p className="text-xs text-white/90" style={{ fontFamily: 'Poppins, sans-serif' }}>
                      {status.desc}
                    </p>
                  </div>
                ))}
