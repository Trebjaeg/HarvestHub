...
export default function BuyerContactSupportHelp() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Header */}
      <div className="text-white py-12" style={{ background: 'linear-gradient(135deg, #1e40af 0%, #3b82f6 100%)' }}>
        <div className="container mx-auto px-4">
            ...
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-bold mb-2" style={{ fontFamily: 'Poppins, sans-serif' }}>
                  Buyer Contact Support Help
                </h1>
                <p className="text-blue-100 text-lg" style={{ fontFamily: 'Poppins, sans-serif' }}>
                  Get assistance through live chat or email support for all your shopping needs
                </p>
              </div>
            </div>
          </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mt-8">
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-6">
                      ...
                      <p className="text-gray-700 mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>
                        Get immediate help with orders, payments, deliveries, and product questions.
                      </p>
                      <div className="bg-blue-100 p-3 rounded-lg">
                        <p className="text-sm text-blue-800 font-medium" style={{ fontFamily: 'Poppins, sans-serif' }}>
                          💬 Look for the chat bubble on any HarvestHub page
                        </p>
                      </div>
                    </div>
